...
* @see app/Http/Controllers/Tenant/ProductController.php:18
* @route '/products'
*/
...
* @see app/Http/Controllers/Tenant/ProductController.php:37
...
* @see app/Http/Controllers/Tenant/ProductController.php:42
* @route '/products'
*/
...
* @see app/Http/Controllers/Tenant/ProductController.php:49
...
* @see app/Http/Controllers/Tenant/ProductController.php:56
...
* @see app/Http/Controllers/Tenant/ProductController.php:63
* @route '/products/{product}'
*/
