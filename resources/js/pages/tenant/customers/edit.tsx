...
type Customer = { id: number; name: string; phone: string | null; email: string | null; address: string | null; note: string | null };
    ...
    return (
        <>
            ...
            <div className="mx-auto max-w-lg p-6">
                <h1 className="mb-6 text-lg font-semibold">Редактировать клиента</h1>

                <Form action={`/customers/${customer.id}`} method="patch" className="flex flex-col gap-5">
                    {({ errors, processing }) => (
                        <>
                            <div className="flex flex-col gap-1.5">
                                <Label htmlFor="name">Имя / Название *</Label>
                                <Input id="name" name="name" autoFocus defaultValue={customer.name} />
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <Textarea id="note" name="note" rows={2} defaultValue={customer.note ?? ''} />
